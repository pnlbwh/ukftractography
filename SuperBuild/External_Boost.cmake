...
if(NOT ( DEFINED "USE_SYSTEM_${extProjName}" AND "${USE_SYSTEM_${extProjName}}" ) )
  ...
  if(MSVC)
    if(MSVC_VERSION GREATER_EQUAL 1400 AND MSVC_VERSION LESS 1500) # VS 2005
      list(APPEND Boost_b2_Command toolset=msvc-8.0)
    elseif(MSVC_VERSION GREATER_EQUAL 1500 AND MSVC_VERSION LESS 1600) # VS 2008
      list(APPEND Boost_b2_Command toolset=msvc-9.0)
    elseif(MSVC_VERSION GREATER_EQUAL 1600 AND MSVC_VERSION LESS 1700) # VS 2010
      list(APPEND Boost_b2_Command toolset=msvc-10.0)
    elseif(MSVC_VERSION GREATER_EQUAL 1700 AND MSVC_VERSION LESS 1800) # VS 2012
      list(APPEND Boost_b2_Command toolset=msvc-11.0)
    elseif(MSVC_VERSION GREATER_EQUAL 1800 AND MSVC_VERSION LESS 1900) # VS 2013
      list(APPEND Boost_b2_Command toolset=msvc-12.0)
    elseif(MSVC_VERSION GREATER_EQUAL 1900 AND MSVC_VERSION LESS 1910) # VS 2015
