...
class NODDI1F : public FilterModel
  {
public:
  NODDI1F(ukfPrecisionType qs, ukfPrecisionType qkappa, ukfPrecisionType qvic, ukfPrecisionType rs, const ukfVectorType& weights_on_tensors, bool constrained)
    : FilterModel(6, rs, weights_on_tensors, constrained), _lambda_min(100.0)
  {
    _Q(0, 0) = _Q(1, 1) = _Q(2, 2) = qs;
     _Q(4, 4) =qkappa;
...
class NODDI2F : public FilterModel
  {
public:
  NODDI2F(ukfPrecisionType qs, ukfPrecisionType qkappa, ukfPrecisionType qvic, ukfPrecisionType rs, const ukfVectorType& weights_on_tensors, bool constrained)
